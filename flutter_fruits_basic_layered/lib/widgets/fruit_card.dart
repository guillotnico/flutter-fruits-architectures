  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(fruit.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const SizedBox(height: 6),
            Text('Famille: ${fruit.family}', style: TextStyle(color: Colors.grey.shade700)),
            const SizedBox(height: 2),
            Text('${fruit.nutritions.calories} cal • ${fruit.nutritions.sugar}g sucre', style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
          ],
        ),
        trailing: Column(
          ...
          children: [
            ...
            Text('${fruit.nutritions.protein}g', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
          ],
        ),
        onTap: () {
          showDialog(
